							...
							get: {
								...
								inputEvent: function() {
									return O.createElement('input').oninput !== D
										? 'input'
										: O.createElement('input').onpropertychange !== D ? 'propertychange' : 'keyup';
								},
			...
			(F.fn.form.settings = {
				...
				rules: {
					...
					containsExactly: function(e, t) {
						return (
							(t = t.replace(F.fn.form.settings.regExp.escape, '\\$&')), -1 !== e.search(new RegExp(t))
						);
					},
												...
												: t == v.rightArrow
													? (f && !r && n.first().addClass(h.active),
														r &&
															...
															c
																? u
																	? d ? n.removeClass(h.active) : g.focusSearch()
																	: s
									...
									return (
										...
										!!e &&
											(e.data(b.value) !== J
												...
												: 'string' == typeof t ? Y.trim(t.toLowerCase()) : String(t))
									);
								},
								inputEvent: function() {
									var e = T[0];
						...
						(s = {
							...
							get: {
								...
								source: function(e) {
									return i.source
										? i.source
										: d.data(a.source) !== A ? d.data(a.source) : s.determine.source();
								},
								type: function() {
									var e = s.get.source();
									...
									return (
										'localstorage' == i.storageMethod && x.localStorage !== C
											...
											: 'sessionstorage' == i.storageMethod && x.sessionStorage !== C
												...
												: y.cookie !== C ? (n = y.cookie(e)) : s.error(l.noCookieStorage),
								...
								remove: function(e) {
									...
									'localstorage' == i.storageMethod && x.localStorage !== C
										...
										: 'sessionstorage' == i.storageMethod && x.sessionStorage !== C
											...
											: y.cookie !== C ? y.removeCookie(e, t) : s.error(l.noStorage);
								},
							},
							setting: function(e, t) {
							...
							get: {
								...
								inputEvent: function() {
									...
									return e !== D && e.oninput !== D
										? 'input'
										: e !== D && e.onpropertychange !== D ? 'propertychange' : 'keyup';
								},
								value: function() {
									return v.val();
								},
							...
							set: {
								...
								stageSize: function() {
									var e = d.clone().addClass(l.loading),
										...
										n = g
											? e.find(s.side).eq(g)
											: 0 < t.next(s.side).length ? t.next(s.side) : e.find(s.side).first(),
										i =
											'next' == r.width
												? n.outerWidth(!0)
							...
							get: {
								direction: function() {
									return g.hasClass(a.top)
										? a.top
										: g.hasClass(a.right) ? a.right : g.hasClass(a.bottom) ? a.bottom : a.left;
								},
								transition: function() {
									var e,
										t = c.get.direction();
									return (
										(e = c.is.mobile()
											? 'auto' == u.mobileTransition
												...
												: u.mobileTransition
											: 'auto' == u.transition ? u.defaultTransition.computer[t] : u.transition),
							...
							get: {
								...
								duration: function(e) {
									return (
										...
										'string' == typeof e
											? -1 < e.indexOf('ms') ? parseFloat(e) : 1e3 * parseFloat(e)
											: e
									);
								},
								displayType: function(e) {
